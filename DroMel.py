...
Catalog = ["DroMel"]
Demographic_Model = [["OutOfAfrica_2L06", "AFR"]]
Number_Of_Simulation = ["100"]
Number_Of_Sample = ["100"]
Window_Size = ["128"]
Selection_Coefficient = ["0.5", "0.05"] #["0.05", "0.005"] change first, basic code in stdpopsim
Generation_Time = ["5000", "10000"] #["200", "1000"] why those number can not work
Minimum_Frequency_AtTheEnd = ["1"] #["0.5", "1"]
Scaling_Factor = ["2000"]
Chromosome = [["2L", "3334875", "3354829"]] #, ["3R", "25637843", "25651874"], ["X", "13846116", "13986442"]]
