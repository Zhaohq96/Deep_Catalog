...
def help():
	...
	print("\t-D/--DFE: the distribution of fitness effects (str) (default: None)")
...
def main(argv):
	...
	opts, ars = getopt.getopt(argv, "hi:C:d:c:g:l:r:p:P:s:n:m:D:S:t:f:a:o:", ["help", "catalog=", "demography=", "chr=", "gen-map=", "left=", "right=", "population=", "pop-size=", "num-sample=", "num-pop=", "sim-type=", "DFE=", "sele-coef=", "gen-time=", "min-freq=", "scaling-factor=", "output="])
	...
	Std_Simulation.simulator(seed, catalog, demo_model, chrm, gen_map, left, right, pop, pop_size, num_sam, num_pop, sim_type, DFE, sel_coef, mut_gen_time, min_fre, scaling, output)
