...
__Step1:__ RAiSD-AI installation and compilation
```
...
```
__Step2:__ Deep_Catalog download
```
...
```
__Step3:__ Virtual environment installation
```
 conda env create -f environment-raisd-ai.yml; conda activate raisd-ai;
```
